          ...
          'OS=="win"',
          {
            ...
            'actions': [
              ...
              },
              {
                ...
                'outputs': [
                  '<(module_root_dir)/deps/librdkafka/win32/outdir/v140/x64/Release/librdkafkacpp.lib',
                  '<(module_root_dir)/deps/librdkafka/win32/outdir/v140/x64/Release/librdkafka.lib'
                ],
            ...
            'copies': [
              {
                'files': [
                  '<(module_root_dir)/deps/librdkafka/win32/outdir/v140/x64/Release/zlib.dll',
                  '<(module_root_dir)/deps/librdkafka/win32/outdir/v140/x64/Release/librdkafka.dll',
                  '<(module_root_dir)/deps/librdkafka/win32/outdir/v140/x64/Release/librdkafkacpp.dll'
                ],
            ...
            'msvs_settings': {
              'VCCLCompilerTool': {
                'AdditionalUsingDirectories': [
                  '<(module_root_dir)/deps/librdkafka/win32/outdir/v140/x64/Release/'
                ]
              }
            },
            'sources': [
